...
const logger = log.getLogger('timer-watchface')
...
WatchFace({
  ...
  onInit() {
    logger.log('watchface on init invoke')
  },

  build() {
    logger.log('watchface on build invoke')
    this.initView()
  },

  onDestroy() {
    logger.log('watchface on destroy invoke')
  },
})
